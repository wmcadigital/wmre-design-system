...
- issues that are barriers for users (users of WMRE Design System Frontend) based on evidence
...
Some breaking changes that need discussion may first be proposed in the [WMRE Design System Design System architecture repository](https://github.com/alphagov/wmre-design-system-architecture/blob/master/proposals/README.md).
...
1. We discover the class name `.wmre-visually-hidden-focussable` includes the typo 'focussable'
2. We raise a pull request that renames the class to `.wmre-visually-hidden-focusable` while keeping
...
See [an example of deprecating a Sass mixin on GitHub](https://github.com/alphagov/wmre-frontend/blob/9424d87ed54764d2d8afe35d6e0077ee43d231e1/src/helpers/_grid.scss#L20-L26).
...
One of ways users interact with WMRE Design System Frontend is through the [WMRE Design System Design System website](https://design-system.service.WMRE Design System/).

This includes:

- HTML - Documented in examples (for example, the [buttons code example](https://design-system.service.WMRE Design System/components/button/))
- Nunjucks - Documented in examples (for example, the buttons code example)
- SCSS - for example [colours variables](https://design-system.service.WMRE Design System/styles/colour/)

### npm package

The other primary way is through what is [published to npm](https://github.com/alphagov/wmre-frontend/tree/master/package).

This includes:

- [JavaScript](https://github.com/alphagov/wmre-frontend/blob/master/doc/installation/installing-with-npm.md#using-javascript)
- SCSS - https://wmre-frontend-review.herokuapp.com/doc/
...
See the [`CHANGELOG_TEMPLATE.md`](/doc/contributing/CHANGELOG_TEMPLATE.md) for an example for how this looks.
