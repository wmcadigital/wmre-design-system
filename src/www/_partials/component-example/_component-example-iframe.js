...
const componentExampleIframe = () => {
  const iframeExamples = document.querySelectorAll('.wmre-website-code-example__iframe');
  ...
  iframeExamples.forEach(iframeElement => {
    ...
    ajax.open('GET', `${host}/img/wmre-icons.min.svg`, true); // Fire off ajax to get spritesheet
    ajax.send();
      ...
      <!DOCTYPE html>
        <html>
          <head>
            ...
            <link rel="stylesheet" type="text/css" href="${host}/css/wmre.min.css" />
            <link rel="stylesheet" type="text/css" href="${host}/css/wmre-website.min.css" />
          </head>
          <body>
            <div class="wmre-p-md wmre-iframe-content">
              ${svgSprite}
              ${html || ''}
            </div>
            <script src="https://unpkg.com/iframe-resizer@3.5.7/js/iframeResizer.contentWindow.min.js"></script>
            <script src="https://polyfill.io/v3/polyfill.min.js?features=Promise%2CObject.assign%2CString.prototype.includes%2CNumber.isNaN"></script>
            <script src="${host}/js/wmre-website.min.js"></script>
          </body>
        </html>
      `;
