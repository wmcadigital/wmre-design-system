const seeExampleFullScreen = () => {
  const fullScreenBtns = document.querySelectorAll('.wmre-website-code-example__view-fullscreen');
  ...
  fullScreenBtns.forEach(btn => {
    ...
    const closeFullScreen = () => {
      codeExampleDiv.classList.remove('wmre-website-code-example--fullscreen'); // Remove full screen class
    ...
    const handleClick = () => {
      ...
      const openFullScreen = () => {
        codeExampleDiv.classList.add('wmre-website-code-example--fullscreen'); // Add full screen class
      ...
      if (codeExampleDiv.classList.contains('wmre-website-code-example--fullscreen')) {
